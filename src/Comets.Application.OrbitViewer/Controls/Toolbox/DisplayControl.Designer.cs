namespace Comets.Application.OrbitViewer.Controls
{
	partial class DisplayControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel.Controls.Add(this.lblCenter);
			...
			this.panel.Controls.Add(this.cbxLabelVenus);
			this.panel.Controls.Add(this.btnAllOrbits);
			this.panel.Controls.Add(this.rbtnCenterMars);
			this.panel.Controls.Add(this.lblComet);
			this.panel.Controls.Add(this.cbxOrbitEarth);
			this.panel.Controls.Add(this.lblNeptune);
			this.panel.Controls.Add(this.cbxOrbitMars);
			this.panel.Controls.Add(this.lblUranus);
			this.panel.Controls.Add(this.rbtnCenterJupiter);
			this.panel.Controls.Add(this.lblSaturn);
			this.panel.Controls.Add(this.cbxLabelEarth);
			this.panel.Controls.Add(this.lblJupiter);
			this.panel.Controls.Add(this.cbxLabelMars);
			this.panel.Controls.Add(this.lblMars);
			this.panel.Controls.Add(this.rbtnCenterSaturn);
			this.panel.Controls.Add(this.lblEarth);
			this.panel.Controls.Add(this.cbxOrbitJupiter);
			this.panel.Controls.Add(this.lblVenus);
			this.panel.Controls.Add(this.cbxOrbitSaturn);
			this.panel.Controls.Add(this.lblMercury);
			this.panel.Controls.Add(this.rbtnCenterUranus);
			this.panel.Controls.Add(this.lblSun);
			this.panel.Controls.Add(this.cbxLabelJupiter);
			this.panel.Controls.Add(this.btnAllOrbitsLabels);
			this.panel.Controls.Add(this.cbxLabelSaturn);
			this.panel.Controls.Add(this.btnDefaultOrbitsLabels);
			this.panel.Controls.Add(this.rbtnCenterNeptune);
			this.panel.Controls.Add(this.rbtnCenterMercury);
			this.panel.Controls.Add(this.cbxOrbitUranus);
			this.panel.Controls.Add(this.cbxLabelComet);
			this.panel.Controls.Add(this.cbxOrbitNeptune);
			this.panel.Controls.Add(this.cbxOrbitComet);
			this.panel.Controls.Add(this.rbtnCenterComet);
			...
			this.lblLabels.TabIndex = 41;
			this.lblLabels.Text = "LABEL:";
			// 
			// lblOrbits
			// 
			...
			this.lblOrbits.TabIndex = 40;
			this.lblOrbits.Text = "ORBIT:";
			// 
			// btnNoOrbits
			// 
			this.btnNoOrbits.Location = new System.Drawing.Point(4, 22);
			...
			this.cbxOrbitMercury.Location = new System.Drawing.Point(20, 23);
			...
			this.cbxOrbitVenus.Location = new System.Drawing.Point(35, 23);
			...
			// btnNoLabels
			// 
			this.btnNoLabels.Location = new System.Drawing.Point(4, 56);
			...
			this.rbtnCenterEarth.Location = new System.Drawing.Point(51, 92);
			...
			this.rbtnCenterVenus.Location = new System.Drawing.Point(36, 92);
			...
			this.cbxLabelMercury.Location = new System.Drawing.Point(20, 57);
			...
			// btnAllLabels
			// 
			this.btnAllLabels.Location = new System.Drawing.Point(154, 56);
			...
			this.cbxLabelVenus.Location = new System.Drawing.Point(35, 57);
			...
			// btnAllOrbits
			// 
			this.btnAllOrbits.Location = new System.Drawing.Point(154, 22);
			...
			this.rbtnCenterMars.Location = new System.Drawing.Point(66, 92);
			...
			this.cbxOrbitEarth.Location = new System.Drawing.Point(50, 23);
			...
			this.cbxOrbitMars.Location = new System.Drawing.Point(65, 23);
			...
			this.rbtnCenterJupiter.Location = new System.Drawing.Point(81, 92);
			...
			this.cbxLabelEarth.Location = new System.Drawing.Point(50, 57);
			...
			this.cbxLabelMars.Location = new System.Drawing.Point(65, 57);
			...
			this.rbtnCenterSaturn.Location = new System.Drawing.Point(96, 92);
			...
			this.cbxOrbitJupiter.Location = new System.Drawing.Point(80, 23);
			...
			this.cbxOrbitSaturn.Location = new System.Drawing.Point(95, 23);
			...
			this.rbtnCenterUranus.Location = new System.Drawing.Point(111, 92);
			...
			this.cbxLabelJupiter.Location = new System.Drawing.Point(80, 57);
			...
			// btnAllOrbitsLabels
			// 
			this.btnAllOrbitsLabels.Location = new System.Drawing.Point(90, 129);
			...
			this.cbxLabelSaturn.Location = new System.Drawing.Point(95, 57);
			...
			// 
			this.btnDefaultOrbitsLabels.Location = new System.Drawing.Point(4, 129);
			...
			this.rbtnCenterNeptune.Location = new System.Drawing.Point(126, 92);
			...
			this.rbtnCenterMercury.Location = new System.Drawing.Point(21, 92);
			...
			this.cbxOrbitUranus.Location = new System.Drawing.Point(110, 23);
			...
			this.cbxLabelComet.Location = new System.Drawing.Point(140, 57);
			...
			this.cbxOrbitNeptune.Location = new System.Drawing.Point(125, 23);
			...
			this.rbtnCenterComet.Location = new System.Drawing.Point(141, 92);
			...
			this.rbtnCenterSun.Location = new System.Drawing.Point(6, 92);
			...
			this.cbxLabelUranus.Location = new System.Drawing.Point(110, 57);
			...
			this.cbxLabelNeptune.Location = new System.Drawing.Point(125, 57);
